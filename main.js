...
sketchname = quick_draw_data_set[random_no];
console.log(sketchname);
document.getElementById("Guess").innerHTML = "Sketch to be drawn : " + sketchname;
function draw(){
...
function updateCanvas(){
    background("white");
    document.getElementById(random_no).innerHTML = "";
    document.getElementById(quick_draw_data_set).innerHTML = "";
}
function preload(){
